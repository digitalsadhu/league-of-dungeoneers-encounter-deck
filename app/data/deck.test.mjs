...
test("app/data/deck - assigning a name - creates a Deck with name and uuid", () => {
...
test("app/data/deck - addCard - inserts object into the collection", () => {
  const data = {
    key: "r1",
    type: "Room",
    name: "some room",
...
test("app/data/deck - addCard - inserts card into the collection", () => {
  const data = {
    key: "r1",
    type: "Room",
    name: "some room",
...
test("app/data/deck - addCard - validation checked before adding", () => {
  const data = { key: "r1" };
  const deck = new Deck();
  const card = new Card(data);
...
test("app/data/deck - from - add an array of cards from json data", () => {
  const data = [
    {
      key: "r1",
      type: "Room",
...
test("app/data/deck - toJSON - serializes to json data", () => {
  const deck = new Deck();
  deck.addCard({
    key: "r1",
    type: "Room",
...
test("app/data/deck - removeCard - by object - removes card from the collection", () => {
  const data = {
    key: "r1",
    type: "Room",
    name: "some room",
...
test("app/data/deck - removeCard - by key - removes card from the collection", () => {
  const data = {
    key: "r1",
    type: "Room",
    name: "some room",
...
test("app/data/deck - removeCard - by card object - removes card from the collection", () => {
  const data = {
    key: "r1",
    type: "Room",
    name: "some room",
...
test('app/data/deck - filter - by type "Room"', () => {
...
test('app/data/deck - filter - by group "The Ancient Lands"', () => {
  const data1 = { key: "r1", type: "Room", name: "...", doors: 2, group: "Core" };
...
test('app/data/deck - filter - by key "r1"', () => {
  const data1 = { key: "r1", type: "Room", name: "...", doors: 2, group: "Core" };
  const data2 = { key: "c1", type: "Corridor", name: "...", doors: 2, group: "The Ancient Lands" };
  const deck = new Deck();
  deck.addCard(new Card(data1));
...
test('app/data/deck - filter - by name "Storage Room"', () => {
...
test('app/data/deck - filter - by number of doors "4"', () => {
  const data1 = { key: "r18b", type: "Room", name: "Storage Room", doors: 2, group: "Core" };
...
test("app/data/deck - filter - by array of keys", () => {
  const data1 = { key: "r18b", type: "Room", name: "Storage Room", doors: 2, group: "Core" };
  const data2 = { key: "c14", type: "Corridor", name: "Cross Passage", doors: 4, group: "Core" };
...
test("app/data/deck - filter - by type and group", () => {
...
test("app/data/deck - shuffle - randomises the order of cards", () => {
  const data1 = { key: "r1", type: "Room", name: "Room 1", doors: 2, group: "Core" };
  const data2 = { key: "r2", type: "Room", name: "Room 2", doors: 2, group: "Core" };
  const data3 = { key: "r3", type: "Room", name: "Room 3", doors: 2, group: "The Ancient Lands" };
  const data4 = { key: "c1", type: "Corridor", name: "Corridor 1", doors: 2, group: "Core" };
...
test("app/data/deck - pick - picks a number of cards as specified and returns a new deck", () => {
  const data1 = { key: "r1", type: "Room", name: "Room 1", doors: 2, group: "Core" };
  const data2 = { key: "r2", type: "Room", name: "Room 2", doors: 2, group: "Core" };
  const data3 = { key: "r3", type: "Room", name: "Room 3", doors: 2, group: "The Ancient Lands" };
  const data4 = { key: "c1", type: "Corridor", name: "Corridor 1", doors: 2, group: "Core" };
...
test("app/data/deck - merge - merges 2 decks into a new deck", () => {
  const data1 = { key: "r1", type: "Room", name: "Room 1", doors: 2, group: "Core" };
  const data2 = { key: "r2", type: "Room", name: "Room 2", doors: 2, group: "Core" };
  const data3 = { key: "r3", type: "Room", name: "Room 3", doors: 2, group: "The Ancient Lands" };
  const data4 = { key: "c1", type: "Corridor", name: "Corridor 1", doors: 2, group: "Core" };
...
test("app/data/deck - split (even numbers) - splits a deck in half to create 2 decks of equal size", () => {
  const data1 = { key: "r1", type: "Room", name: "Room 1", doors: 2, group: "Core" };
  const data2 = { key: "r2", type: "Room", name: "Room 2", doors: 2, group: "Core" };
  const data3 = { key: "r3", type: "Room", name: "Room 3", doors: 2, group: "The Ancient Lands" };
  const data4 = { key: "c1", type: "Corridor", name: "Corridor 1", doors: 2, group: "Core" };
...
test("app/data/deck - split (odd numbers) - splits a deck roughly in half to create a first deck with 1 more card than the second", () => {
  const data1 = { key: "r1", type: "Room", name: "Room 1", doors: 2, group: "Core" };
  const data2 = { key: "r2", type: "Room", name: "Room 2", doors: 2, group: "Core" };
  const data3 = { key: "r3", type: "Room", name: "Room 3", doors: 2, group: "The Ancient Lands" };
  const data4 = { key: "c1", type: "Corridor", name: "Corridor 1", doors: 2, group: "Core" };
